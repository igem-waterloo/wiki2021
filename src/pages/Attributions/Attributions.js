                    ...
                    <Collapsible open title="Team Members">
                        <div className={overallStyles.text_div}>
                            ...
                            <ul className={overallStyles.description}>
                                ...
                                <li>
                                    Voltage to illuminance conversion research	</li>
                            </ul> 
                        </div>
                        <div className={overallStyles.description}>
                            Special thanks to Alisha D’souza, Rahim Jiwani, and Patrick Thomas for contributions to the project this year despite not being official members. Your help is greatly appreciated throughout project selection, implementation, and outreach.
                        </div>
                    </Collapsible>
                </div>
            </div>
