        ...
        return (
            <div className={overallStyles.container}>
                ...
                <Collapsible open title="Design">
                    ...
                    <div className={overallStyles.description}>
                        <div className={overallStyles.figure_div} style={{marginBottom: 30}}>
                            <img src="https://2021.igem.org/wiki/images/c/c1/T--Waterloo--MCFAoverview.png" className={styles.design_img} style={{borderRadius: 20}}></img>
                            <div className={overallStyles.figure_text}>Figure __: Simplified diagram of the microfluidic assay chip.</div>
                        </div>
                    ...
                    <div className={overallStyles.description}>
                        ...
                        <div className={overallStyles.figure_div} style={{marginBottom: 30}}>
                            ...
                            <div className={overallStyles.figure_text}>Figure __: Assembly of the microfluidic chip. Note that the top plane surfaces are transparent for easy visualization of the chip inner components.</div>
                        </div>

                        <div className={overallStyles.figure_div} style={{marginBottom: 30}}>
                            <img src="https://2021.igem.org/wiki/images/5/5e/T--Waterloo--LabelledChipGood.png" className={styles.design_img} style={{borderRadius: 20}}></img>
                            <div className={overallStyles.figure_text}>Figure __: Full assembly of the microfluidic chip. Fluid flows from the top left through the capillary pump through to the spiral control chamber, then to the spiral test chamber. At the same time, fluid flows from the top right through the drying chamber and into the spiral test chamber.</div>
                        </div>
                        
                        <div style={{margin: '20px 0 40px 0'}}>
                            <span className={styles.sub_heading}>Sample Loading Chamber and Drying Chamber Design</span>
                        </div>
                        ...
                        <div className={overallStyles.figure_div} style={{marginBottom: 30}}>
                            <img src="https://2021.igem.org/wiki/images/f/f5/T--Waterloo--LabelledDryingChamber.png" className={styles.design_img} style={{borderRadius: 20}}></img>
                            <div className={overallStyles.figure_text}>Figure __:  Annotated loading and drying chamber.</div>
                        </div>

                        <div style={{margin: '20px 0 40px 0'}}>
                            <span className={styles.sub_heading}>Capillary Pump Design</span>
                        </div>
                        ...
                        <div className={overallStyles.figure_div} style={{marginBottom: 30}}>
                            ...
                            <div className={overallStyles.figure_text}>Figure __:  Various Capillary Pump Designs (Olanrewaju et al., 2018)</div>
                        </div>
                        
                        <p>We chose to compare three different microstructures and their effect on fluid flow: (1) symmetric oblong shapes ($400$ by $200 \mu \text); (2) treelines in the shape of a hexagon (thickness $1 \textmm); and (3) balled lines (radius $500 \mu \text, lines $1 \text).</p>

                        <div className={overallStyles.figure_div} style={{marginBottom: 30}}>
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-around', flexWrap: 'wrap'}}>
                                <img src="https://2021.igem.org/wiki/images/b/b5/T--Waterloo--processOblongMicrostructures.png" className={styles.design_img} style={{borderRadius: 20, width: '32%', height: '32%'}}></img>
                                <img src="https://2021.igem.org/wiki/images/7/78/T--Waterloo--processTreeMicrostructures.png" className={styles.design_img} style={{borderRadius: 20, width: '30%', height: '30%'}}></img>
                                <img src="https://2021.igem.org/wiki/images/1/11/T--Waterloo--ProcessBalledlineMicrostructures.png" className={styles.design_img} style={{borderRadius: 20, width: '31%', height: '31%'}}></img>
                            </div>
                            <div className={overallStyles.figure_text}>Figure __:  (a) Oblong microstructures. (b) Treeline microstructures. (c) Balled lines microstructures.</div>
                        </div>
                        ...
                        <div className={overallStyles.figure_div} style={{marginBottom: 30}}>
                            <img src="https://2021.igem.org/wiki/images/a/a0/T--Waterloo--processCapillaryPumpLower.png" className={styles.design_img} style={{borderRadius: 20, width: '70%', height: '70%'}}></img>
                            <div className={overallStyles.figure_text}>Figure __:  Sample of the lower common components of the capillary pump with oblong microstructures as an example.</div>
                        </div>
                        ...
                        <p>Our initial iteration utilized a high-pressure capillary pump consisting of oblong shapes that are $400$ by $200 \mu \text. These serve as posts in the chamber. According to Ghosh et al. (2020) [a], the motivation for a high-pressure capillary pump is to prevent reagents from accumulating in and around the edges of the posts and walls. This also facilitates rapid fluid flow from the openings to the reaction chambers.</p>

                        <div className={overallStyles.figure_div} style={{marginBottom: 30}}>
                            <img src="https://2021.igem.org/wiki/images/1/1e/T--Waterloo--processOblongiter1.png" className={styles.design_img} style={{borderRadius: 20}}></img>
                            <div className={overallStyles.figure_text}>Figure __:  Full image of iteration 1.</div>
                        </div>
                        ...
                        <div className={overallStyles.figure_div} style={{marginBottom: 30}}>
                            <img src="https://2021.igem.org/wiki/images/b/b4/T--Waterloo--processOblongiter2.png" className={styles.design_img} style={{borderRadius: 20}}></img>
                            <div className={overallStyles.figure_text}>Figure __:  Full image of iteration 2.</div>
                        </div>
                        ...
                        <div className={overallStyles.figure_div} style={{marginBottom: 30}}>
                            <img src="https://2021.igem.org/wiki/images/1/10/T--Waterloo--processOblongiter3.png" className={styles.design_img} style={{borderRadius: 20}}></img>
                            <div className={overallStyles.figure_text}>Figure __:  Full image of iteration 3.</div>
                        </div>
                ...
                <Collapsible open title="Build">
                    ...
                    <div className={overallStyles.description}>
                        ...
                        <div className={overallStyles.figure_div} style={{marginBottom: 30}}>
                            ...
                            <div className={overallStyles.figure_text}>Figure __:  Dimensioned drawing of the microfluidic chip.</div>
                        </div>
                    ...
                    <div className={overallStyles.description}>
                        ...
                        <div style={{margin: '20px 0 40px 0'}}>
                            <span className={styles.sub_heading}>Protocol for Covalent Conjugation of Biomolecules Containing Free Amine Groups:</span>
                        </div>
                        ...
                        <ol className={overallStyles.description} style={{marginTop: 0}}>
                            ...
                            <li>Conduct in-flow treatment ($0.15 \text/\text$) of a 10% w/v solution of APTES at $80^\circ \text for 3 hours.</li>
                            <li>Derivatize the silanized microstructure in a 2.5% w/v solution of glutaraldehyde (GA) for 2 hours at room temperature.</li>
                            <li>Recirculate $95 \mu \frac\text/\text$ of the molecule to be immobilized over the microstructure for 10-15 hours to achieve covalent immobilization. The specific amount of immobilized molecule can be determined through the difference in its concentration of the solution before and after immobilization.</li>
                            <li>Circulate bovine serum albumin (BSA) blocking buffer ($20 \text/\text$) through the microstructure for 30 minutes to ensure that the unbinded areas of PDMS are blocked from picking up extraneous molecules in the urine that may interfere with the function of the microarray.</li>
                        </ol>
                        </p>

                        <div style={{margin: '20px 0 40px 0'}}>
                            <span className={styles.sub_heading}>Covalent Conjugation of RNA:</span>
                        </div>
                    ...
                    <div className={overallStyles.description}>
                        ...
                        <div style={{margin: '20px 0 40px 0'}}>
                            <span className={styles.sub_heading}>Lyophilization of Small Biomolecules</span>
                        </div>
                        ...
                        <ol className={overallStyles.description} style={{marginTop: 0}}>
                            ...
                            <li>Freeze-dry the above solutions in a freeze-drying system (ex: <strong>Labconco Lyophilizer HRFD-SCIL</strong>) set at $-54^\circ\text with $0.010 \text pressure for 24 hours.</li>
                        </ol>
                        </p>

                        <div style={{margin: '20px 0 40px 0'}}>
                            <span className={styles.sub_heading}>Protein Lyophilization</span>
                        </div>
                        ...
                        <p>
                        <ol className={overallStyles.description} style={{marginTop: 0}}>
                            <li>Dissolve protein to $2.0 \text/\text in potassium phosphate buffer ($20 \text, pH 7.4).</li>
                            <li>Dialyze protein solution against a phosphate buffer ($20 \text, pH 7.4) for 24h at $4^\circ\text. Switch out the dialysis buffer twice within the 24h period - once after 1h elapsed time, and once more after 2h total elapsed time.</li>
                            <li>Filter protein solution through a $0.2 \mu \text syringe filter.</li>
                            <li>Prepare sucrose ($2.0 \text/\text), glycine ($2.0 \text/\text), urea ($2.0 \text), and guanidine-HCl ($2.0 \text) solutions in phosphate buffer. Filter these solutions through a $0.2 \mu\text syringe filter, and store at $4^\circ\text.</li>
                        </ol>
                        </p>
                        ...
                        <ol className={overallStyles.description} style={{marginTop: 0}}>
                            ...
                            <ul className={overallStyles.description} style={{marginTop: 5, marginBottom: 5}}>
                                <li>The protein to additive ratio should be 1:1 by weight for sucrose and glycine, with final urea and guanidine-HCl concentrations of $1.0 \text. To encourage cake formation, 5% trehalose should be added as a key additive. This is based on the personal experience of one of our lab members, and differs from the procedure of Roughton et al. (2013).</li>
                            </ul>
                            <li>Add $400 \mu\text of the lyophilization formulation to a lyophilization vial.</li>
                            ...
                            <ol className={overallStyles.description} style={{marginTop: 5, marginBottom: 5}}>
                                <li>Pre-cool shelves at $-2^\circ\text for 15 min.</li>
                                <li>Freeze samples at $-40^\circ\text for 50 min.</li>
                                <li>Dry samples under vacuum ($100 \text) at $-35^\circ\text for 10 h, $-20^\circ\text for 8 h, $-5^\circ\text for 6 h, $10^\circ\text for 6 h, $25^\circ\text for 6 h, and $4^\circ\text for 0.5 h. This removes water by sublimation.</li>
                            </ol>
                        </ol>
                        </p>
                    </div>
                ...
                <Collapsible open title="Test">
                    <div className={styles.text_div}>
                        <span className={overallStyles.text_heading}>COMSOL</span>
                    </div>
                    <div className={overallStyles.description}>
                        TO DO
                    </div>
