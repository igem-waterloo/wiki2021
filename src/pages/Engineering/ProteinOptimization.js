        ...
        return (
            <div className={overallStyles.container}>
                ...
                <Collapsible open title="Build">
                    ...
                    <div className={overallStyles.description}>
                        <div style={{margin: '20px 0 40px 0'}}>
                            <span className={styles.sub_heading}>Results: Trypsin Single Mutation</span>
                        </div>
                        ...
                        <div style={{margin: '20px 0 40px 0'}}>
                            <span className={styles.sub_heading}>Single Mutation Result Interpretation</span>
                        </div>
                        ...
                        <div style={{margin: '20px 0 40px 0'}}>
                            <span className={styles.sub_heading}>Results: Double Mutations with Rosetta</span>
                        </div>
                        ...
                        <div style={{margin: '20px 0 40px 0'}}>
                            <span className={styles.sub_heading}>Results: Trypsin Multiple Mutations</span>
                        </div>
                    ...
                    <div className={overallStyles.description}>
                        ...
                        <div style={{margin: '20px 0 40px 0'}}>
                            <span className={styles.sub_heading}>Results: Monomeric Streptavidin Single Mutation</span>
                        </div>
                    ...
                    <div className={overallStyles.description}>
                        ...
                        <Table bordered className={overallStyles.table}>
                            ...
                            <tbody>
                                ...
                                <tr>
                                <td>monomeric_streptavidin_complexed_ignorechain_HETATM</td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
                ...
                <Collapsible open title="Learn">
                    ...
                    <div className={overallStyles.description}>
                        <p>Based on Rosetta scores, the improved protein for streptavidin consisted of the 4 mutations, T74C, N12A, Y52F, Y52F.</p>
